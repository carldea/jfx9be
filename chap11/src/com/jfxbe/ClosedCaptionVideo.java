 ...
 * using media events for closed captions.
 * 
 * @author carldea
 */
public class ClosedCaptionVideo extends Application {
   ...
   public void start(Stage primaryStage) {
      ...
      // Closed Caption text
      Node closedCaptionText = createClosedCaptionArea(root);
      AnchorPane.setLeftAnchor(closedCaptionText, 150.0);
      AnchorPane.setRightAnchor(closedCaptionText, 60.0);
      AnchorPane.setBottomAnchor(closedCaptionText, 10.0);
   ...
   /**
    * Create a close caption area (Label node)
    * @return
    */
   private Node createClosedCaptionArea(Pane root) {
      // create message area
      Label closedCaption = new Label();
      closedCaption.setWrapText(true);
      closedCaption.setId("closed-caption-text");
   ...
   private void playMedia(String url, Pane root) {
      ...
      media.getMarkers().put("The gentlemen makes it to the finish line.",
